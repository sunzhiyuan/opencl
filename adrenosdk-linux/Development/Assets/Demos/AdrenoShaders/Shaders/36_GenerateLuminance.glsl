...
void main()
{
  //  vec4 FocusPixel = texture2D( g_ColorTexture, g_TexCoord );
	...
	// luminance values            
	// somehow we have to raise the value range here for the log function .... probably
	// because of the low precision of the render targets
	const vec3 LUMINANCE = vec3(0.2125, 0.7154, 0.0721) *  10.5;      
