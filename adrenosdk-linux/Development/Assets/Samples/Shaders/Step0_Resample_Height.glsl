...
void main()
{
    ...
    vec4 h04 = vec4( texture( heightMap, texcoord0.xy ).xy, texture( heightMap, texcoord4.xy ).xy )/65535.0;
    vec4 h15 = vec4( texture( heightMap, texcoord1.xy ).xy, texture( heightMap, texcoord5.xy ).xy )/65535.0;
    vec4 h26 = vec4( texture( heightMap, texcoord2.xy ).xy, texture( heightMap, texcoord6.xy ).xy )/65535.0;
    vec4 h37 = vec4( texture( heightMap, texcoord3.xy ).xy, texture( heightMap, texcoord7.xy ).xy )/65535.0;
