...
public:
    ...
    //! \param  [in] The sky dome vertex count
...
private:
    ...
    struct  HoffmanScatterConstantBuffer
    {
        ...
        FRMVECTOR4 EyePos;
        FRMVECTOR4 SunDir;
        FRMVECTOR4 BetaRPlusBetaM;
        FRMVECTOR4 HGg;
        FRMVECTOR4 BetaDashR;
        FRMVECTOR4 BetaDashM;
        FRMVECTOR4 OneOverBetaRPlusBetaM;
        FRMVECTOR4 Multipliers;
        FRMVECTOR4 SunColorAndIntensity;    	
        
    };

    CFrmConstantBuffer* m_pHoffmanScatterConstantBuffer;
    HoffmanScatterConstantBuffer m_HoffmanScatterConstantBufferData;
	CFrmShaderProgramD3D m_HoffmanScatterShader;	
    CFrmShaderProgramD3D m_HoffmanScatterTerrainShader;

    CFrmVertexBuffer* m_pSkyLightVertexBuffer;
    CFrmIndexBuffer* m_pSkyLightIndexBuffer;

    CFrmVertexBuffer* m_pTerrainVertexBuffer;
    CFrmIndexBuffer* m_pTerrainIndexBuffer;
