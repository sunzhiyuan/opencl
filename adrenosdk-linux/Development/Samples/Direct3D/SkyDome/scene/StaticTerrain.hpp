...
public:
    ...
    //! \brief  Returns the landscape vertex count
	...
	CFrmTexture*  getTerrainMap() const {return m_pTerrainMap;}
	CFrmTexture*  getNormalMap() const {return m_pNormalMap;}
...
private:
	...
	CFrmTexture*            m_pTerrainMap;               //!< The terrain texture map
    CFrmTexture*            m_pNormalMap;                //!< The terrain normal map
