...
ifeq ($(ENABLE_NEON),true)
	...
	LOCAL_CFLAGS += -ffast-math -funsafe-math-optimizations -fno-strict-aliasing -Wno-conversion-null -Wno-write-strings
else
	# VFP mode
	LOCAL_CFLAGS := $(LOCAL_C_INCLUDES:%=-I%) -DUSE_PTHREADS -mfpu=vfp -mfloat-abi=softfp -pthread -DOS_ANDROID -Wno-conversion-null -Wno-write-strings
endif

LOCAL_CFLAGS += -DCORE_GL_CONTEXT

LOCAL_MODULE := CompressedGeometry

LOCAL_SRC_FILES := $(SRC_PATH)/Scene.cpp \
                   $(SRC_PATH)/CompressedMesh.cpp \
                   $(SRC_PATH)/Eigenvector.cpp \
...
#LOCAL_CFLAGS += -Wno-psabi -Wno-conversion-null -Wcast-align
