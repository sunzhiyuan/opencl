...
ifeq ($(ENABLE_NEON),true)
	...
	LOCAL_CFLAGS := -g $(LOCAL_C_INCLUDES:%=-I%) -DHALTI -D_OGLES3 -DUSE_PTHREADS -mfpu=neon -mfloat-abi=softfp -pthread -DSCE_PFX_USE_SIMD_VECTORMATH -DOS_ANDROID  -ffast-math -funsafe-math-optimizations -fno-strict-aliasing
else
	# VFP mode
