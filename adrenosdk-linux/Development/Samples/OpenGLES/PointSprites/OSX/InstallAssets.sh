...
cp ${BIN_DIR}/Samples/Shaders/PointSprites.vs ${TARGET_DIR}/Shaders
cp ${BIN_DIR}/Samples/Shaders/PointSprites.fs ${TARGET_DIR}/Shaders
cp ${BIN_DIR}/Samples/Fonts/Tuffy12.pak ${TARGET_DIR}/Fonts
cp ${BIN_DIR}/Samples/Textures/PointSprites.pak ${TARGET_DIR}/Textures
