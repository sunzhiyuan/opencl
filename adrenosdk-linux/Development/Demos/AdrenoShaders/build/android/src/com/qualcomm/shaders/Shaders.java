...
//=============================================================================
public class Shaders extends Activity implements
...
//=============================================================================
{
	...
	private static final String LOG_TAG = "Shaders";
	private static final String STATE_TAG_POINTER = "com.qualcomm.shaders:mNativeObjectPointer";
	private static final String STATE_TAG_PID = "com.qualcomm.shaders:pid";
	...
	//protected final native void nativeLoadAssets(android.content.res.AssetManager assetMgr);
	...
	static {
		try {
			System.loadLibrary("AdrenoShaders");
			registerNativeFns();
