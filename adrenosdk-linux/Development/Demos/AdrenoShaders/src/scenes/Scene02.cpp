...
// Desc: Constructor
//--------------------------------------------------------------------------------------
CSample02::CSample02( const CHAR* strName ) : CScene( strName )
{
...
BOOL CSample02::InitShaders()
{
    // Create the PerPixelLighting shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/Diffuse.vs",
                                                      "Demos/AdrenoShaders/Shaders/Diffuse.fs",
...
// Desc: 
//--------------------------------------------------------------------------------------
BOOL CSample02::Initialize(CFrmFontGLES &m_Font, CFrmTexture* m_pLogoTexture)
{
