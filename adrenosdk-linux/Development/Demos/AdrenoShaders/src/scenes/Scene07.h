...
//--------------------------------------------------------------------------------------
// Name: class CSample07
// Desc: The main application class for this sample
//--------------------------------------------------------------------------------------
class CSample07 : public CScene
{
...
private:    
    ...
    // Shader related data
    CFrmCubeMap*       m_pLightingCubeMap;
    ...
    UINT32             m_hCubeMapLightingShader;
