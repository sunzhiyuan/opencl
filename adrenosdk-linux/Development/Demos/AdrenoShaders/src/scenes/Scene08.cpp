...
// Desc: Constructor
//--------------------------------------------------------------------------------------
CSample08::CSample08( const CHAR* strName ) : CScene( strName )
{
    ...
    m_nTextureId                       = 1; // Want to start on second one since it is cooler
...
BOOL CSample08::InitShaders()
{
    // Create the Stencil Volume shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/ParallaxMapping.vs",
                                                      "Demos/AdrenoShaders/Shaders/ParallaxMapping.fs",
...
// Desc: 
//--------------------------------------------------------------------------------------
BOOL CSample08::Initialize(CFrmFontGLES &m_Font, CFrmTexture* m_pLogoTexture)
{
    ...
    if( FALSE == resource.LoadFromFile( "Demos/AdrenoShaders/Textures/08_Textures.pak" ) )
        return FALSE;
    ...
    m_UserInterface.AddFloatVariable( &m_fParallax, (char *)"Parallax", (char *)"%4.3f" );
    m_UserInterface.AddFloatVariable( &m_vSpecular.x, (char *)"Specular", (char *)"%4.3f" );
 //   m_UserInterface.AddBoolVariable( &m_bBumpMappingOn, "Bump Mapping" );
  //  m_UserInterface.AddBoolVariable( &m_bParallaxMappingOn, "Parallax Mapping" );
    m_UserInterface.AddFloatVariable( &m_vViewPosition.y, (char *)"View Position" );
    m_UserInterface.AddFloatVariable( &m_fRotateX, (char *)"X-Rotation" );
    m_UserInterface.AddFloatVariable( &m_fRotateY, (char *)"Y-Rotation" );
    ...
    m_UserInterface.AddHelpKey( FRM_FONT_KEY_1, (char *)"Toggle Texture Set" );
...
//    m_UserInterface.AddHelpKey( FRM_FONT_KEY_3, "Toggle Parallax Mapping" );
    m_UserInterface.AddHelpKey( FRM_FONT_KEY_4, (char *)"Decrease Parallax" );
    m_UserInterface.AddHelpKey( FRM_FONT_KEY_5, (char *)"Increase Parallax" );
    m_UserInterface.AddHelpKey( FRM_FONT_KEY_6, (char *)"Decrease Specular Lighting" );
    m_UserInterface.AddHelpKey( FRM_FONT_KEY_7, (char *)"Increase Specular Lighting" );
    m_UserInterface.AddHelpKey( FRM_FONT_KEY_8, (char *)"Zoom In" );
    m_UserInterface.AddHelpKey( FRM_FONT_KEY_9, (char *)"Zoom Out" );
    m_UserInterface.AddHelpKey( FRM_FONT_KEY_DPAD, (char *)"Rotate Plane" );

     // Load the meshes
    if( FALSE == m_Floor.Load( "Demos/AdrenoShaders/Meshes/Plane.mesh" ) )
        return FALSE;
