...
// Desc: Constructor
//--------------------------------------------------------------------------------------
CSample12::CSample12( const CHAR* strName ) : CScene( strName )
{
...
BOOL CSample12::InitShaders()
{
    // Create the PerPixelLighting shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/Ashikhmin.vs",
                                                      "Demos/AdrenoShaders/Shaders/Ashikhmin.fs",
...
// Desc: 
//--------------------------------------------------------------------------------------
BOOL CSample12::Initialize(CFrmFontGLES &m_Font, CFrmTexture* m_pLogoTexture)
{
...
VOID CSample12::Update()
{
    ...
    FRMVECTOR3 vPosition = FRMVECTOR3( 0.0f, 0.20f, 6.0f );
