...
// Desc: Constructor
//--------------------------------------------------------------------------------------
CSample03::CSample03( const CHAR* strName ) : CScene( strName )
{
...
BOOL CSample03::InitShaders()
{
    // Create the PerPixelLighting shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/Specular.vs",
                                                      "Demos/AdrenoShaders/Shaders/Specular.fs",
...
// Desc: 
//--------------------------------------------------------------------------------------
BOOL CSample03::Initialize(CFrmFontGLES &m_Font, CFrmTexture* m_pLogoTexture)
{
