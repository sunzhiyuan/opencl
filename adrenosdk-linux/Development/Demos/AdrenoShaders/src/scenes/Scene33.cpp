...
// Desc:
//--------------------------------------------------------------------------------------
MaterialShader33::MaterialShader33()
{
    ShaderId = 0;
}
...
// Desc:
//--------------------------------------------------------------------------------------
DownsizeShader33::DownsizeShader33()
{
    ShaderId = 0;
}
...
// Desc:
//--------------------------------------------------------------------------------------
CombineShader33::CombineShader33()
{
    ShaderId = 0;
...
// Desc:
//--------------------------------------------------------------------------------------
VOID SimpleObject33::Update( FLOAT ElapsedTime, BOOL ShouldRotate )
{
    if( ShouldRotate )
...
// Desc: Constructor
//--------------------------------------------------------------------------------------
CSample33::CSample33( const CHAR* strName ) : CScene( strName )
{
    m_nWidth = 800;
    m_nHeight = 480;
}
...
// Desc: 
//--------------------------------------------------------------------------------------
BOOL CSample33::CheckFrameBufferStatus()
{
...
// Desc: 
//--------------------------------------------------------------------------------------
BOOL CSample33::Initialize(CFrmFontGLES &Font, CFrmTexture* m_pLogoTexture)
{
    m_ShouldRotate = TRUE;
    ...
    m_UserInterface.AddFloatVariable( &m_CombineShader.BloomIntensity, (char *)"Bloom Intensity" );
  	m_UserInterface.AddHelpKey( FRM_FONT_KEY_1, (char *)"Decrease bloom intensity" );
    m_UserInterface.AddHelpKey( FRM_FONT_KEY_2, (char *)"Increase bloom intensity" );
...
BOOL CSample33::InitShaders()
{
    // Create the material shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/MaterialShader33.vs", "Demos/AdrenoShaders/Shaders/MaterialShader33.fs",
    ...
    // downsize shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/DownsizeShader33.vs", "Demos/AdrenoShaders/Shaders/DownsizeShader33.fs",
    ...
    // blur shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/BlurShader33.vs", "Demos/AdrenoShaders/Shaders/BlurShader33.fs",
    ...
    // combine shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/CombineShader33.vs", "Demos/AdrenoShaders/Shaders/CombineShader33.fs",
...
// Desc: 
//--------------------------------------------------------------------------------------
FRMVECTOR3 GetCameraPos33( FLOAT32 fTime )
{
...
VOID CSample33::Update()
{
    ...
    {
        m_CombineShader.BloomIntensity -= 8.0f * ElapsedTime;
    ...
    FRMVECTOR3 LookPos = GetCameraPos33( TotalTime + 0.05f );
    m_CameraPos   = GetCameraPos33( TotalTime );
...
//--------------------------------------------------------------------------------------
// Name: GaussianDistribution33()
// Desc: 
//--------------------------------------------------------------------------------------
FLOAT32 GaussianDistribution33( FLOAT32 X, FLOAT32 Y, FLOAT32 Rho )
{
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample33::SetupGaussWeights()
{
    ...
    for( int i = 0; i < 4; i++ )
    {
        ...
        m_BlurShader.GaussWeight[i] = GaussianDistribution33( X, 0.0f, m_CombineShader.GaussRho );
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample33::DrawObject( SimpleObject33* Object )
{
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample33::GaussBlur( OffscreenRT4& TargetRT )
{
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample33::CreateBlurredImage()
{
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample33::DrawCombinedScene()
{
