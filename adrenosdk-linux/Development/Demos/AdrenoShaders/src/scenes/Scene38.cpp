...
// Desc:
//--------------------------------------------------------------------------------------
MaterialShader38::MaterialShader38()
{
    ShaderId = 0;
}
...
// Desc:
//--------------------------------------------------------------------------------------
DownsizeShader38::DownsizeShader38()
{
    ShaderId = 0;
}
...
// Desc:
//--------------------------------------------------------------------------------------
CombineShader38::CombineShader38()
{
    ShaderId = 0;
...
// Desc:
//--------------------------------------------------------------------------------------
VOID SimpleObject38::Update( FLOAT ElapsedTime, BOOL ShouldRotate )
{
    if( ShouldRotate )
...
// Desc: Constructor
//--------------------------------------------------------------------------------------
CSample38::CSample38( const CHAR* strName ) : CScene( strName )
{
    m_nWidth = 800;
    m_nHeight = 480;
}
...
// Desc: 
//--------------------------------------------------------------------------------------
BOOL CSample38::CheckFrameBufferStatus()
{
...
// Desc: 
//--------------------------------------------------------------------------------------
BOOL CSample38::Initialize(CFrmFontGLES &Font, CFrmTexture* m_pLogoTexture)
{
    m_ShouldRotate = TRUE;
...
BOOL CSample38::InitShaders()
{
    // Create the material shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/MaterialShader38.vs", "Demos/AdrenoShaders/Shaders/MaterialShader38.fs",
    ...
    // downsize shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/DownsizeShader38.vs", "Demos/AdrenoShaders/Shaders/DownsizeShader38.fs",
    ...
    // blur shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/BlurShader38.vs", "Demos/AdrenoShaders/Shaders/BlurShader38.fs",
    ...
    // combine shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/CombineShader38.vs", "Demos/AdrenoShaders/Shaders/CombineShader38.fs",
...
// Desc: 
//--------------------------------------------------------------------------------------
FRMVECTOR3 GetCameraPos38( FLOAT32 fTime )
{
...
VOID CSample38::Update()
{
    ...
    FRMVECTOR3 LookPos = GetCameraPos38( TotalTime + 0.05f );
    m_CameraPos   = GetCameraPos38( TotalTime );
...
//--------------------------------------------------------------------------------------
// Name: GaussianDistribution38()
// Desc: 
//--------------------------------------------------------------------------------------
FLOAT32 GaussianDistribution38( FLOAT32 X, FLOAT32 Y, FLOAT32 Rho )
{
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample38::SetupGaussWeights()
{
    ...
    for( int i = 0; i < 4; i++ )
    {
        ...
        m_BlurShader.GaussWeight[i] = GaussianDistribution38( X, 0.0f, m_CombineShader.GaussRho );
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample38::DrawObject( SimpleObject38* Object )
{
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample38::GaussBlur( OffscreenRT4& TargetRT )
{
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample38::CreateBlurredImage()
{
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample38::DrawCombinedScene()
{
