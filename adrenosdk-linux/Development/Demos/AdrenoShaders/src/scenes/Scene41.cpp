...
BOOL CSample41::InitShaders()
{
    // Create the material shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/MaterialShader41.vs", "Demos/AdrenoShaders/Shaders/MaterialShader41.fs",
    ...
    // downsize shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/DownsizeShader41.vs", "Demos/AdrenoShaders/Shaders/DownsizeShader41.fs",
    ...
    // blur shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/BlurShader41.vs", "Demos/AdrenoShaders/Shaders/BlurShader41.fs",
    ...
    // combine shader
    {
        ...
        if( FALSE == FrmCompileShaderProgramFromFile( "Demos/AdrenoShaders/Shaders/CombineShader41.vs", "Demos/AdrenoShaders/Shaders/CombineShader41.fs",
...
// Desc: 
//--------------------------------------------------------------------------------------
VOID CSample41::GaussBlur( OffscreenRT4& TargetRT )
{
